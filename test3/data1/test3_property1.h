...
class Test3_Property1 : public DataUiHandlerProperty
{
    Q_OBJECT
    Q_PROPERTY(QString foo READ foo WRITE setFoo NOTIFY fooChanged)
public:
    explicit Test3_Property1(QObject *parent = 0);
    explicit Test3_Property1(DataUiHandlerProperty * copyProperty, QObject *parent = 0);
